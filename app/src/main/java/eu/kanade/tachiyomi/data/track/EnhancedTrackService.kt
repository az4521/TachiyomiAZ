 ...
 *
 * Ported from Mihon's `EnhancedTracker`, adapted to this app's [TrackService] API.
 */
interface EnhancedTrackService {
    ...
    /**
     * Enhanced trackers reuse the credentials of the source they are bound to, so there is
     * nothing to log into. Call this to mark the service as logged in.
     */
    fun loginNoop()

    /**
     * Similar to [TrackService.search], but only returns zero or one match.
     */
