...
extension SearchContentView {
    ...
    class ViewModel: ObservableObject {
        ...
        var sources: [ExtensionRunner.Source] = []
    ...
    func updateFilters(_ filters: [FilterValue]) {
        ...
        if !searchQuery.isEmpty {
            ...
            searchTask = Task {
                ...
                let filteredSources: [ExtensionRunner.Source] = filteredSources()
...
extension SearchContentView.ViewModel {
    ...
    private func filteredSources() -> [ExtensionRunner.Source] {
    ...
    private func appendFetchedData(query: String, sources: [ExtensionRunner.Source]) async {
