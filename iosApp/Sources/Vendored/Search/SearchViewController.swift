...
class SearchViewController: UIViewController {
    ...
    private var sources: [ExtensionRunner.Source] = [] {
        didSet {
    ...
    private var availableFilters: [ExtensionRunner.Filter] {
        var filters: [ExtensionRunner.Filter] = [
            .init(
                id: "contentRating",
    ...
    private func open(result: SearchContentView.ViewModel.SearchResult) {
        // Upstream branches to its pre-runner source screen for legacy sources. This port has
        // none -- see Vendored/_excluded/LegacySourceUI -- so every result opens the runner screen.
        let sourceController = NewSourceViewController(
