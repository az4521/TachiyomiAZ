...
struct PageInterceptorProcessor: ImageProcessing {
    ...
    func process(_ container: ImageContainer, context: ImageProcessingContext) throws -> ImageContainer {
        ...
        let output: ExtensionRunner.PlatformImage? = try BlockingThrowingTask {
    ...
    func processAsync(_ container: ImageContainer, context: ImageProcessingContext) async throws -> ExtensionRunner.PlatformImage? {
