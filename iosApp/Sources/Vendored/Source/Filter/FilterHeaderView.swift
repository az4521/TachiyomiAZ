...
struct FilterHeaderView: View {
    ...
    let filters: [ExtensionRunner.Filter]
    @Binding var search: String
    @Binding var enabledFilters: [FilterValue]
    let onFilterButtonClick: (() -> Void)?
    let onFilterSheetDismiss: (() -> Void)?

    @State private var sortedFilters: [ExtensionRunner.Filter]
    @State private var showingSheet = false

    init(
        sourceKey: String? = nil,
        filters: [ExtensionRunner.Filter],
        ...
        var enabled: [ExtensionRunner.Filter] = []
        var disabled: [ExtensionRunner.Filter] = []
