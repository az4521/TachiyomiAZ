...
struct SortFilterView: View {
    let filter: ExtensionRunner.Filter

    @Binding var enabledFilters: [FilterValue]

    private let canAscend: Bool
    private let options: [String]
    private let defaultValue: ExtensionRunner.Filter.SortDefault?
    ...
    init(filter: ExtensionRunner.Filter, enabledFilters: Binding<[FilterValue]>) {
        self.filter = filter
...
struct SortFilterGroupView: View {
    ...
    let canAscend: Bool
    let options: [String]
    let defaultValue: ExtensionRunner.Filter.SortDefault?

    @Binding var selectedOption: Int
    @Binding var ascending: Bool

    init(
        filter: ExtensionRunner.Filter,
