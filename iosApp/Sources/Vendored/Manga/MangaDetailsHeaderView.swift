...
struct MangaDetailsHeaderView: View {
    @Binding var source: ExtensionRunner.Source?

    @Binding var manga: ExtensionRunner.Manga
    @Binding var chapters: [ExtensionRunner.Chapter]
    @Binding var nextChapter: ExtensionRunner.Chapter?
    ...
    init(
        source: Binding<ExtensionRunner.Source?>,
        manga: Binding<ExtensionRunner.Manga>,
        chapters: Binding<[ExtensionRunner.Chapter]>,
        nextChapter: Binding<ExtensionRunner.Chapter?>,
...
#Preview {
    ...
    MangaDetailsHeaderView(
        source: Binding.constant(ExtensionRunner.Source.demo()),
        manga: Binding.constant(ExtensionRunner.Manga(
            sourceKey: "",
            key: "",
            title: "Manga",
            authors: ["Author"],
