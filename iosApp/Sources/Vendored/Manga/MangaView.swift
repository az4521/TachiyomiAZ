...
struct MangaView: View {
    ...
    @State private var openChapter: ExtensionRunner.Chapter?
    ...
    init(
        source: ExtensionRunner.Source? = nil,
...
extension MangaView {
    ...
    @ViewBuilder
    func viewForChapter(_ chapter: ExtensionRunner.Chapter, index: Int, secondSection: Bool = false) -> some View {
        ...
        Section {
            ...
            if !last && !secondSection {
                Menu(NSLocalizedString("MARK_PREVIOUS")) {
                    Button {
                        let chapters = [ExtensionRunner.Chapter](viewModel.chapters[
...
extension MangaView {
    func showShareSheet(chapter: ExtensionRunner.Chapter) {
