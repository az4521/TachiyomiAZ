...
class ReaderViewController: BaseObservingViewController {
    ...
    var chapter: ExtensionRunner.Chapter
    var pages: [Page] = []
    var readingMode: ReadingMode = .rtl
    var defaultReadingMode: ReadingMode?
    private var tapZone: TapZone?

    private var chapterList: [ExtensionRunner.Chapter]
    private var chaptersToMark: [ExtensionRunner.Chapter] = []
    private var chaptersToRemoveDownload: [ExtensionRunner.Chapter] = [] {
        didSet {
...
//                    recognizer.isEnabled = true
    ...
    func updateReadPosition(
        currentPage: Int? = nil,
        totalPages: Int? = nil,
        chapter: ExtensionRunner.Chapter? = nil
    ) async {
        ...
        await HistoryManager.shared.setProgress(
            chapter: ChapterIdentifier(sourceKey: sourceId, mangaKey: mangaId, chapterKey: chapter.key),
    ...
    private func saveReadingSession(chapter: ExtensionRunner.Chapter? = nil) async {
...
extension ReaderViewController: ReaderHoldingDelegate {
    ...
    private func areDuplicates(_ a: ExtensionRunner.Chapter, _ b: ExtensionRunner.Chapter) -> Bool {
        a.chapterNumber == b.chapterNumber
            && a.volumeNumber == b.volumeNumber
            && (!(a.chapterNumber == nil && a.volumeNumber == nil) || a.title == b.title)
    }

    private func isValidScanlatorMatch(for next: ExtensionRunner.Chapter, current: Set<String>) -> Bool {
    ...
    private func findBestChapterMatch(from index: Int, step: Int) -> ExtensionRunner.Chapter {
    ...
    func getNextChapter() -> ExtensionRunner.Chapter? {
        ...
        index -= 1
        var nextChapterInList: ExtensionRunner.Chapter?
