...
class ReaderTextViewController: BaseViewController {
    ...
    private var chapter: ExtensionRunner.Chapter?
    /// The chapter before the first loaded section (for the top transition).
    private var previousChapter: ExtensionRunner.Chapter?
    /// The chapter after the last loaded section (for the bottom transition).
    private var nextChapter: ExtensionRunner.Chapter?
    ...
    private func createInlineTransitionView(
        finishedChapter: ExtensionRunner.Chapter,
        nextChapter: ExtensionRunner.Chapter?
    ) -> ReaderInfoPageView {
...
extension ReaderTextViewController {
    ...
    func loadInitialChapter(_ chapter: ExtensionRunner.Chapter, restorePosition: Bool = true) async {
...
extension ReaderTextViewController: ReaderReaderDelegate {
    ...
    func setChapter(_ chapter: ExtensionRunner.Chapter, startPage: Int) {
