...
struct MigrateSingleSearchView: View {
    ...
    let selectedSeries: ExtensionRunner.Manga

    var resultSeries: Binding<ExtensionRunner.Manga?>?

    struct SearchResult: Identifiable, Equatable {
        let source: ExtensionRunner.Source
        let result: ExtensionRunner.MangaPageResult
    ...
    @State private var targetSeries: ExtensionRunner.Manga?
    ...
    init(
        ...
        resultSeries: Binding<ExtensionRunner.Manga?>? = nil
    ) {
...
extension MigrateSingleSearchView {
    func search(delay: Bool = false) {
        ...
        searchTask = Task {
            ...
            await withTaskGroup(of: (ExtensionRunner.Source, ExtensionRunner.MangaPageResult?).self) { group in
