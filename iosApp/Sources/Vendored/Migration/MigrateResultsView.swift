...
struct MigrateResultsView: View {
    let targetSources: [ExtensionRunner.Source]
    @State private var selectedSeries: [ExtensionRunner.Manga]
    ...
    @State private var migratedManga: [MangaIdentifier: ExtensionRunner.Manga?] = [:]
    @State private var newChapters: [MangaIdentifier: [ExtensionRunner.Chapter]] = [:]
    ...
    init(
        targetSources: [ExtensionRunner.Source],
        selectedSeries: [ExtensionRunner.Manga],
...
extension MigrateResultsView {
    func remove(manga: ExtensionRunner.Manga) {
    ...
    func migratedMangaBinding(for key: MangaIdentifier) -> Binding<ExtensionRunner.Manga?> {
        .init(
...
extension MigrateResultsView {
    func startMatching() async {
        ...
        await withTaskGroup(of: (MangaIdentifier, ExtensionRunner.Manga?).self) { group in
...
extension MigrateResultsView {
    struct MangaToMangaView: View {
        ...
        let toSource: String?
        let fromManga: ExtensionRunner.Manga
        @Binding var toManga: ExtensionRunner.Manga?
