...
class MangaCollectionViewController: BaseCollectionViewController {
    ...
    var entries: [ExtensionRunner.Manga] = []
    ...
    override func observe() {
        ...
        addObserver(forName: .addToLibrary) { [weak self] notification in
            guard
                let self,
                let manga = notification.object as? ExtensionRunner.Manga,
...
extension MangaCollectionViewController {
    ...
    typealias GridCellRegistration = UICollectionView.CellRegistration<MangaGridCell, ExtensionRunner.Manga>
    typealias ListCellRegistration = UICollectionView.CellRegistration<MangaListCell, ExtensionRunner.Manga>
    ...
    func makeDataSource() -> UICollectionViewDiffableDataSource<Section, ExtensionRunner.Manga> {
        if usesListLayout {
    ...
    func updateDataSource() {
        var snapshot = NSDiffableDataSourceSnapshot<Section, ExtensionRunner.Manga>()
